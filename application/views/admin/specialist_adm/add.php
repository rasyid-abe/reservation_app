    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="<?php echo base_url('admin/specialist_adm/add') ?>" enctype="multipart/form-data">
                    ...
                    <a href="<?php echo base_url('root/specialist_adm') ?>" class="btn btn-danger">Kembali</a>
                </form>
            </div>
        </div>
    </div>
