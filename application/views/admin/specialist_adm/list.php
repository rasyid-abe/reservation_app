<div class="card mb-4">
    <form class="" action="<?php echo base_url('admin/specialist_adm/check_ids') ?>" method="post">
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="button">
                    ...
                    <a href="<?php echo base_url('admin/specialist_adm/add') ?>" class="btn btn-sm btn-info">Tambah Spesialis</a>
                </div>
            </div>
        </div>
    <div class="card-body">
                    ...
                    <?php foreach ($list as $key => $v): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url('admin/specialist_adm/edit/' . $v['id']) ?>" class="btn btn-sm btn-warning"></i>Ubah</a>
                            </td>
