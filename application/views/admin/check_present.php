            ...
            <form class="" action="<?php echo base_url('root/user_doctor/check_ids') ?>" method="post">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="button">
                            <a href="<?php echo base_url('admin/home_adm') ?>" class="btn btn-danger">Kembali</a>
                            <?php if ($row->status ==  1): ?>
                                <a href="<?php echo base_url('admin/home_adm/set_present/' . $row->id_reservasi) ?>" class="btn btn-success">Proses</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <table width="100%" style="color: white">
                        ...
                        <tr>
                            <th colspan="4" class="text-center">
                                <?php if ($row->status !=  1): ?>
                                    <p class="text-dark">Status belum disetujui.</p>
                                <?php else: ?>
                                    &nbsp;
                                <?php endif; ?>
                             </th>
