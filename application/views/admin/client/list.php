                    ...
                    <?php foreach ($list as $key => $v): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url('admin/user_client_adm/edit/' . $v['id_user']) ?>" class="btn btn-sm btn-warning"></i>Ubah</a>
                                <a href="<?php echo base_url('admin/user_client_adm/reset/' . $v['id_user']) ?>" class="btn btn-sm btn-danger"></i>Reset</a>
                                <a href="<?php echo base_url('admin/user_client_adm/detail/' . $v['id_user']) ?>" class="btn btn-sm btn-info"></i>Detail</a>
                            </td>
