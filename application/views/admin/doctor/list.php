<div class="card mb-4">
    <form class="" action="<?php echo base_url('admin/user_doctor_adm/check_ids') ?>" method="post">
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="button">
                    ...
                    <a href="<?php echo base_url('admin/user_doctor_adm/add') ?>" class="btn btn-sm btn-info">Tambah Dokter</a>
                </div>
            </div>
        </div>
    <div class="card-body">
                    ...
                    <?php foreach ($list as $key => $v): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url('admin/user_doctor_adm/edit/' . $v['id_user']) ?>" class="btn btn-sm btn-warning"></i>Ubah</a>
                                <a href="<?php echo base_url('admin/user_doctor_adm/reset/' . $v['id_user']) ?>" class="btn btn-sm btn-danger"></i>Reset</a>
                                <a href="<?php echo base_url('admin/user_doctor_adm/detail/' . $v['id_user']) ?>" class="btn btn-sm btn-info"></i>Detail</a>
                            </td>
