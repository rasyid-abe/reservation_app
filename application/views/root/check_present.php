            ...
            <form class="" action="<?php echo base_url('root/user_doctor/check_ids') ?>" method="post">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="button">
                            <a href="<?php echo base_url('root/home') ?>" class="btn btn-danger">Kembali</a>
                            <?php if ($row->status ==  1): ?>
                                <a href="<?php echo base_url('root/home/set_present/' . $row->id_reservasi) ?>" class="btn btn-success">Proses</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
