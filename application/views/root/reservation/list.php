<div class="card mb-4">
    <form class="" action="<?php echo base_url('root/reservation_ro/type_export') ?>" method="post">
                    ...
                    <?php foreach ($list as $key => $v):
                        ...
                        <tr>
                            <td class="text-center">
                                <a href="<?php echo base_url('root/reservation_ro/detail_reservation/' . $v['id_reservasi']) ?>" class="btn btn-sm btn-info"></i>Detail</a>
                            </td>
