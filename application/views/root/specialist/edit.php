    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="<?php echo base_url('root/specialist/update/'  . $row->id) ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan" id="keterangan" class="form-control form-sm" placeholder="Keterangans" value="<?php echo $row->keterangan ?>">
