<div class="card mb-4">
    <form class="" action="<?php echo base_url('root/billing_ro/type_export') ?>" method="post">
                    ...
                    <?php foreach ($list as $key => $v):?>
                        <tr>
                            <td class="text-center">
                                <a href="<?php echo base_url('root/billing_ro/detail/' . $v['id_biling']) ?>" class="btn btn-sm btn-info"></i>Detail</a>
                                <a href="<?php echo base_url('root/billing_ro/edit/' . $v['id_biling']) ?>" class="btn btn-sm btn-warning"></i>Edit</a>
                            </td>
