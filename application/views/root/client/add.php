    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="<?php echo base_url('root/user_client/add') ?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="hp" id="hp" class="form-control form-sm" placeholder="Handphone" value="<?php echo set_value('hp') ?>">
                    ...
                    <a href="<?php echo base_url('root/user_client') ?>" class="btn btn-danger">Kembali</a>
                </form>
            </div>
        </div>
    </div>
