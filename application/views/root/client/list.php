<div class="card mb-4">
    <form class="" action="<?php echo base_url('root/user_client/check_ids') ?>" method="post">
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="button">
                    ...
                    <a href="<?php echo base_url('root/user_client/add') ?>" class="btn btn-sm btn-info">Tambah Klien</a>
                </div>
            </div>
        </div>
    <div class="card-body">
                    ...
                    <?php foreach ($list as $key => $v): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url('root/user_client/edit/' . $v['id_user']) ?>" class="btn btn-sm btn-warning"></i>Ubah</a>
                                <a href="<?php echo base_url('root/user_client/reset/' . $v['id_user']) ?>" class="btn btn-sm btn-danger"></i>Reset</a>
                                <a href="<?php echo base_url('root/user_client/detail/' . $v['id_user']) ?>" class="btn btn-sm btn-info"></i>Detail</a>
                            </td>
