    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="<?php echo base_url('admin/user_doctor_adm/update/'  . $row->id_user) ?>" enctype="multipart/form-data">
                    <?php echo $this->session->flashdata('message') ?>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="id_number">Nomor ID</label>
                                <input type="text" name="id_number" id="id_number" class="form-control form-sm" placeholder="ID Number" value="<?php echo $row->kode_dokter ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <?php foreach ($sp as $v): ?>
                                <input class="form-check-input" name="sp[]" type="checkbox" id="sp<?php echo $v['id'] ?>" value="<?php echo $v['id'] ?>" <?php echo in_array($v['id'], json_decode($row->spesialis)) ? 'checked' : '' ?>>
