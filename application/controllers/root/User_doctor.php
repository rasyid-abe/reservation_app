...
class User_doctor extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->template->content("root/doctor/list", $data);
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['link_home'] = $this->link;
            $data['days'] = $this->db->get('hari_praktek')->result_array();
            $this->template->content("root/doctor/add", $data);
            $this->template->show('template/home');
        } else {
            $data_user = [
    ...
    public function edit($id)
    {
        ...
        $data['days'] = $this->db->get('hari_praktek')->result_array();
        $data['link_home'] = $this->link;
        $this->template->content("root/doctor/edit", $data);
        $this->template->show('template/home');
    }
    ...
    public function update($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($update) {
                ...
                ');
                redirect('root/user_doctor/edit/' . $id);
            } else {
                $this->session->set_flashdata('message', '
                <div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
