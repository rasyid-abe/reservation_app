...
class Hour extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->template->content("root/hour/list", $data);
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->content("root/hour/add", $data);
            $this->template->show('template/home');
        } else {
            $data = [
    ...
    public function edit($id)
    {
        ...
        $data['link_home'] = $this->link;
        $this->template->content("root/hour/edit", $data);
        $this->template->show('template/home');
    }
