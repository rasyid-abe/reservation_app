...
class Billing_ro extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->template->content("root/billing/list", $data);
    ...
    public function detail($id)
    {
        ...
        $data['link_home'] = $this->link;
        $this->template->content("root/billing/detail", $data);
        $this->template->show('template/home');
    }
    ...
    public function edit($id)
    {
        ...
        $data['link_home'] = $this->link;
        $data['id'] = $id;
        $this->template->content("root/billing/edit", $data);
        $this->template->show('template/home');
    }
    ...
    public function update($id)
    {
        ...
        if ($update) {
            ...
            ');
            redirect('root/billing_ro/detail/' . $id);
        } else {
            $this->session->set_flashdata('message', '
