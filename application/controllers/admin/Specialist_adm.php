...
class Specialist_adm extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->template->content("admin/specialist_adm/list", $data);
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->content("admin/specialist_adm/add", $data);
            $this->template->show('template/home');
        } else {
            $data = [
            ...
            if ($in_user) {
                ...
                ');
                redirect('admin/specialist_adm/add');
            } else {
                $this->session->set_flashdata('message', '
    ...
    public function edit($id)
    {
        ...
        $data['link_home'] = $this->link;
        $this->template->content("admin/specialist_adm/edit", $data);
        $this->template->show('template/home');
    }
    ...
    public function update($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($update) {
                ...
                ');
                redirect('admin/specialist_adm/edit/' . $id);
            } else {
                $this->session->set_flashdata('message', '
                <div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
