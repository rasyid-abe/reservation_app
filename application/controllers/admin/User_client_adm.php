...
class User_client_adm extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->template->content("admin/client/list", $data);
    ...
    public function detail($id)
    {
        ...
        $data['subtitle'] = $subtitle;
        $data['link_home'] = $this->link;
        $data['back'] = 'admin/user_client_adm' ;
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['link_home'] = $this->link;
            $this->template->content("admin/client/add", $data);
            $this->template->show('template/home');
        } else {
            $data_user = [
            ...
            if ($in_user) {
                ...
                ');
                redirect('admin/user_client_adm/add');
            } else {
                $this->session->set_flashdata('message', '
    ...
    public function edit($id)
    {
        ...
        $data['link_home'] = $this->link;
        $this->template->content("admin/client/edit", $data);
        $this->template->show('template/home');
    }
    ...
    public function update($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($update) {
                ...
                ');
                redirect('admin/user_client_adm/edit/' . $id);
            } else {
                $this->session->set_flashdata('message', '
                <div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
    ...
    public function delete($ids)
    {
        ...
        ');
        redirect('admin/user_client_adm');
    }
